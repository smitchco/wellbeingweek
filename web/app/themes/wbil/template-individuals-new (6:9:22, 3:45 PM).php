...
/**
 * Template Name: Individuals New - Custom
 *
 * @since   1.0.0
 *
...
<script>
	...
	<?php 
		...
		switch ( $date ) {
			case "2022-05-03":
				$active_anchor = 'tuesdaymay32022';
			break;
			case "2022-05-04":
				$active_anchor = 'wednesdaymay42022';
			break;
			case "2022-05-05":
				$active_anchor = 'thursdaymay52022';
			break;
			case "2022-05-06":
				$active_anchor = 'fridaymay62022';
			break;
			default: 
				$active_anchor = "mondaymay22022";
		}
	?>
...
if( have_rows('section') ) { 
	...
	while( have_rows('section') ) {
		...
		$no_btn_color = get_sub_field('section_button_no_color');
		$bg_color = get_sub_field('section_color');
		...
		<div class="row mt-3 mb-4">
			...
			<?php 
				if ( get_sub_field('section_type') == 'webinar' ) { 
					...
					if( have_rows('resource_items') || have_rows('section_items_no_button') ) { 

						while( have_rows('resource_items') || have_rows('section_items_no_button')) {
						...
						?>
							...
							<div class="col-12 col-lg-6 ">
								...
								<?php if ( get_sub_field('no_button_time') ) { ?>
									<p class="text-white"><?php echo get_sub_field('no_button_time'); ?></p>
								...
								<h4 class="text-white card__title">
									<?php echo get_sub_field('no_button_title'); ?>
								</h4>
								
								<div class="text-white card__content">
										<?php echo get_sub_field('no_button_description'); ?>
								</div>
