					...
					<div class="col col-lg-11">
						<div class="px-lg-5">
							...
							<div class="wbil-banner mt-5 p-3 p-lg-4 text-center">
								...
								<img src="https://lawyerwellbeing.net/wp-content/uploads/2025/03/iwil-2025-logo-combo-e1741036140587.png" alt="Well-Being Week In Law" class="img-fluid" style="width 100%; max-width: 800px;" />
								<?php //'https://lawyerwellbeing.net/wp-content/uploads/2024/04/wbil-logos-combo.png' ?>
