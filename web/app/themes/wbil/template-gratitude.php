...
<style>
    ...
    [type=radio]:checked + img {
        outline: 5px solid #25A465;
    }

    span.wpcf7-form-control-wrap.radio-649 {
        display: block;
        margin-top: 20px;
        margin-bottom: 20px;
    }
...
<script>
        ...
        images_html += '\
            <div class="col-12 col-lg-6 wpcf7-form-control wpcf7-radio"><span class="wpcf7-list-item first last">\
                <label style="position-relative">\
                    <input type="radio" name="radio-649" value="' + images[i].id + '" checked="checked" >\
    ...
    jQuery(document).ready(function() {
        jQuery('[data-name="radio-649"]').html(images_html);
...
<section class="container-fluid py-3">
    ...
    <div class="row">
        <div class="col-12 col-md-10 col-lg-8 col-xl-6 mx-md-auto">
            ...
            <?php echo do_shortcode('[contact-form-7 id="6650" title="Gratitude Form"]'); ?>
